"""
experiments/complexity_energy_standard.py — Recalcul énergie/complexité
...
MÉTHODOLOGIE (confirmée/appliquée, documentée sans ambiguïté) :
  ...
  - Les 3 architectures neuronales (SingleSC/IntraRB/TA-RB-résiduel,
    ...
    system.py) calculait en FP16 (Q_W=Q_A=16) -- CORRIGÉ ici.
...
Usage: python3 experiments/complexity_energy_standard.py  (CPU suffit, pas de calcul GPU)
"""
