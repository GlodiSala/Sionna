"""
experiments/audit_massive_repro.py -- reproduction exacte de l'evaluation
...
batch_size=64) que training/train_umi_massive_d128.py -- teste directement les
...
EVAL_BATCHES = 20   # == training/train_umi_massive_d128.py
