"""
experiments/wmmse_iters_check.py — Diagnostic direct pour la question du directeur
...
que classical_reference.py (LockedClusterSystem, STANDARD_CONFIG, meme
...
Usage: LD_LIBRARY_PATH=<conda_env>/lib python3 experiments/wmmse_iters_check.py
"""
...
# Import chain identique a classical_reference.py -- pose le seed=42 via
# l'effet de bord du module wmmse_convergence_check (tf.random.set_seed(42),
# np.random.seed(42)) AVANT tout tirage de canal.
from classical_reference import LockedClusterSystem, BATCH_SIZE, NUM_BATCHES, RB_SIZE
...
def main():
    ...
    with open('results/diag_wmmse_iters_check_results.json', 'w') as f:
