"""
experiments/mechanism_sinr_ceiling.py -- derive un plafond de SINR/debit theorique a partir
de P_pred = Delta_sc @ pinv(H_avg) (meme canal/mecanisme que
experiments/mechanism_interference_floor.py : M8K4, UMi, seed=42, LockedClusterSystem,
...
# ---- meme tirage que experiments/mechanism_interference_floor.py (meme seed/mecanisme/ordre d'appel) ----
...
for snr in HIGH_SNRS:
    ...
    # SINR manuel (meme formule que precoders/classical.py:103-110)
