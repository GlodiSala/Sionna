"""
experiments/eval_csi_imperfect_umi_standard.py -- version corrigee de
...
def manual_sinr_rate(stream_management, h_true, g, no):
    ...
    formule que precoders/classical.py:103-110, evaluee sur le VRAI canal h_true
...
def main():
    ...
    out_manual = {'metric': 'manual_sinr (precoders/classical.py:103-110, evalue sur h_true)',
