"""
experiments/eval_csi_imperfect_umi_massive_d384.py -- version corrigee (POINT 3,
regime UMi-massive M64K8 D=384 CSI imparfait) de
diag_csi_imperfect_massive_capD384L4.py.

Corrections (memes que experiments/eval_umi_standard.py) :
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 experiments/eval_csi_imperfect_umi_massive_d384.py
"""
