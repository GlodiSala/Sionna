"""
experiments/ablation_tokens_T.py -- meme methodologie EXACTE que
...
from classical_reference import LockedClusterSystem, RB_SIZE, WMMSE_ITERS
...
BATCH_SIZE = 128          # protocole d'origine (training/train_umi_standard_tarb_Tsweep.py: EVAL_BATCHES=20, batch_size=128)
...
base_meta = {
    ...
    'sampling_note': 'protocole original (training/train_umi_standard_tarb_Tsweep.py: EVAL_BATCHES=20, batch_size=128) -- reprend a l identique le nombre d echantillons/point du run d entrainement, en remplacement du run intermediaire 10x32=320 (tsweep_seedfix_v2.py)',
