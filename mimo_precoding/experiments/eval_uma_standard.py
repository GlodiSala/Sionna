"""
experiments/eval_uma_standard.py -- POINT 1 (Table 3.10, UMa, M8K4,
CSI parfait) : meme methodologie que experiments/eval_umi_standard.py
...
eval_system.py:130-133, herite tel quel par UMaLockedClusterSystem)
...
Ne modifie ni classical_reference.py ni diag_classical_comparison_uma.py.

Usage: python3 experiments/eval_uma_standard.py [--num_batches N]
"""
...
def main():
    ...
    out_manual = {'metric': 'manual_sinr (SINR_k=|h_k^Hw_k|^2/(sum_j!=k|h_k^Hw_j|^2+no), precoders/classical.py:103-110)',
