"""
figB_pareto_energy.py — Figure B, UMi MASSIVE (M=64, K=8) : Pareto
débit/énergie. Pas de T-sweep à cette échelle (TA-RB entraîné à T=6
fixe uniquement) -- 5 points seulement (RZF, WMMSE, SC, IB, TA-RB),
**purement descriptif, aucune recommandation ni mise en avant
visuelle** (consigne utilisateur -- la discussion se fait dans le
texte du chapitre).
...
ax.set_title('Compromis débit / énergie — UMi MASSIVE (M=64, K=8)', fontsize=13, fontweight='bold')
...
print('✅ Figure B (UMi MASSIVE) -> figB_pareto_energy.{png,pdf,json}')
