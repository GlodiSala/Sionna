"""
training/train_uma_standard.py — Priorité 2 (nuit, demande utilisateur) :
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 training/train_uma_standard.py --arch single_sc
"""
