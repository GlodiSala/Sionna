"""
training/train_uma_massive_d128.py — Priorité 4 (nuit, demande utilisateur) :
...
- `training/train_umi_massive_d128.py` (dims M=64/K=8, batch réduit training
  16/16/32, DATASET_SIZE réduit -- contrainte mémoire M=64)
- `training/train_uma_standard.py` (canal UMa via scenario='uma',
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 training/train_uma_massive_d128.py --arch single_sc
"""
