"""
training/train_umi_standard_tarb_Tsweep.py — Étape 1 (demande utilisateur) :
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 training/train_umi_standard_tarb_Tsweep.py --T 3 --finetune_epochs 27
"""
