"""
training/train_umi_standard_sc_variants.py — Front A (demande utilisateur, exploration
...
Variantes :
  ...
  gram          + features Gram matrix H^H.H (precoders/signed_attention.py)
  ...
  bilinear      + couche de mixing bilinéaire signé avant output_proj
                (precoders/signed_attention.py)

Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 training/train_umi_standard_sc_variants.py --variant gram
"""
...
from precoders.signed_attention import (SingleSCTransformerPrecoderGram,
