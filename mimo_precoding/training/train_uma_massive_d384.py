"""
training/train_uma_massive_d384.py — réplique de diag_massive_gap_
...
Différences vs la version UMi :
  ...
  - cache file `sionna_joint_uma_massive_4k_64x8.npz` (au lieu de
    ...
    déjà utilisé par `training/train_uma_massive_d128.py` pour le run D=128 de
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 training/train_uma_massive_d384.py \
...
LR              = 1e-3
DATASET_SIZE    = 4000
CACHE_FILE      = f'/export/tmp/sala/sionna_joint_uma_massive_{DATASET_SIZE//1000}k_{M}x{K}.npz'   # même cache que training/train_uma_massive_d128.py
