...
from precoders.base_intra_rb import IntraRBTransformerPrecoder, SingleSCTransformerPrecoder
from precoders.classical import rzf_precoder, wmmse_precoder, TransformerPrecoderV4, TransformerPrecoderV5
...
from precoders.base_residual import TransformerPrecoderClean, TransformerPrecoderCleanResidual
...
MODELS_TO_TRAIN = [
    ...
    # TransformerPrecoderClean (precoders/base_residual.py) : fix OFDM (1 symbole+tile,
