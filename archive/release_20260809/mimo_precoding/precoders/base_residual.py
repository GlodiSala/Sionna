"""
precoders_v2.py — Architectures "nettoyées" issues du diagnostic du
2026-08-07 :
...
dépendent pas de precoders_w.py) pour pouvoir itérer librement sans
...
class SeparableAttentionBlock(layers.Layer):
    """Identique à precoders_w.py -- attention fréquence -> user -> FFN."""
