"""
diag_front_a_signed_attn_arch.py — Priorité 2 (demande utilisateur) :
...
(cohérence directe) : intra_rb=128 (BATCH_SIZE global main_finall.py),
ta_rb_residual=256 (MODELS_TO_TRAIN['batch_size'], diag_tarb_residual_
test.py).

Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 diag_front_a_signed_attn_arch.py --arch intra_rb
"""
...
from precoder_experimental import (IntraRBTransformerPrecoderSignedAttn,
