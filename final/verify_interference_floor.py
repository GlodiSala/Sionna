"""
verify_interference_floor.py -- verification numerique de l'hypothese :
...
Methodologie :
  ...
  3. Sur ce MEME h_freq, a 0/5/10/15/20dB : RZF-SC (rzf_precoder, alpha=
     ...
     precoders_w.py:103-110), par realisation, pour observer si l'ecart
...
from precoders_w import rzf_precoder, _get_desired_channels
...
def manual_sinr_rate_and_per_user(stream_management, h_freq, g, no):
    """Meme formule que precoders_w.py:103-110 (SINR_k = |h_k^H w_k|^2 /
