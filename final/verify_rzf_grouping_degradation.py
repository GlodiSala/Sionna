"""
verify_rzf_grouping_degradation.py -- montre la degradation progressive du
...
(compare_rb_grouping.py) -- pour T=1, aucune moyenne (groupe de taille 1),
...
from classical_comparison import LockedClusterSystem, BATCH_SIZE
...
def manual_sinr(stream_management, h_freq, g, no):
    ...
    formule que precoders_w.py:103-110. Retourne (sinr [B,ofdm,fft,K],
