"""
diag_system_scheduler_eval.py — Priorité 6b (demande utilisateur) :
...
- WMMSE corrigé (bisection sur µ, `precoders_w.py` actuel) au lieu de
...
Usage:
    python3 diag_system_scheduler_eval.py --smoke                    # 1 méthode x 1 SNR x 10 slots, CSI parfait
    python3 diag_system_scheduler_eval.py                             # sweep complet, CSI parfait
    python3 diag_system_scheduler_eval.py --pilot_snr_db 20           # sweep complet, CSI imparfait (pilote 20dB)
"""
