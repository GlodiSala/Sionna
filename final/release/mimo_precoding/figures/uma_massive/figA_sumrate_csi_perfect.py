"""
figA_sumrate_csi_perfect.py — Figure A, UMa MASSIVE (M=64, K=8), double
panneau (gauche : CSI parfait, droite : CSI imparfait pilote 20dB).
RZF, WMMSE, SC, IB, TA-RB (T=6). Budget étendu (160ep) pour les 3
...
fig.suptitle('Débit somme vs SNR — UMa MASSIVE (M=64, K=8)', fontsize=14, fontweight='bold', y=1.02)
fig.tight_layout()
...
print('✅ Figure A (UMa MASSIVE) -> figA_sumrate_csi_perfect.{png,pdf,json}')
