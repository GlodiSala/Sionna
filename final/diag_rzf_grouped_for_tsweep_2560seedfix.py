"""
diag_rzf_grouped_for_tsweep_2560seedfix.py -- reproduit les courbes
...
(tsweep_seedfix_v2_2560samples.py) : meme seed=42, meme
...
from classical_comparison import LockedClusterSystem, RB_SIZE
...
# -- boucle IDENTIQUE (ordre des appels RNG) a tsweep_seedfix_v2_2560samples.py --
...
out = {
    ...
    'metadata': {
        ...
        'shared_channel': True,
        'shared_channel_note': 'meme sequence exacte de system.new_topology()/channel_and_no() que tsweep_seedfix_v2_2560samples.py (WMMSE/T1-T12 neuronaux non rejoues, deterministes, ne consomment pas config.tf_rng) -- verifie par repro_check_vs_2560run',
        'script': os.path.abspath(__file__), 'script_sha256_16': sha256_of(__file__),
        'precoders_w_sha256_16': sha256_of('precoders_w.py'),
        'compare_rb_grouping_sha256_16': sha256_of('compare_rb_grouping.py'),
