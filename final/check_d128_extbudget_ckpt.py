"""
check_d128_extbudget_ckpt.py -- verifie si le checkpoint "extbudget" (D=128,
...
classical_comparison_massive_seedfix_v2.py.
...
# Checkpoint utilise PAR ERREUR par classical_comparison_massive_seedfix_v2.py
CKPT_WRONG = {
...
t0 = time.time()
print("=== CHECKPOINT UTILISE PAR classical_comparison_massive_seedfix_v2.py (probable cause du bug) ===")
