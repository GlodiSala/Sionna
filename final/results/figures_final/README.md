...
- `uma_massive/` — canal UMa, M=64/K=8. Priorité la plus basse (P4),
  peut ne pas exister si le temps a manqué -- voir SESSION_LOG_20260808.md
  pour le statut exact.
...
(`DATA_DIR = '../../'` pointe vers `results/`, où vivent les données
