...
biais LMMSEPostEqualizationSINR :
  ...
  - Panneau droit (CSI imparfait, pilote 20dB) : donnees regenerees par
    diag_csi_imperfect_seedfix.py (meme script/mecanisme que
...
with open('../../classical_comparison_M8K4_seedfix_manual_sinr_20260820_023135.json') as f:
    left = json.load(f)
snr_left = left['table']['snr']

with open('../../diag_csi_imperfect_seedfix_manual_sinr.json') as f:
    right = json.load(f)
