"""
diag_ber_csi_imperfect.py — Figure D double panneau (demande utilisateur) :
...
validé (main_finall.py), pas de nouvelle logique de détection/LDPC.

Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 diag_ber_csi_imperfect.py
"""
import os, sys, json
import numpy as np
