"""
diag_intermediate_snr_annexe_b.py — Annexe B (demande utilisateur) :
...
Usage: CUDA_VISIBLE_DEVICES=<gpu> python3 diag_intermediate_snr_annexe_b.py --regime umi_standard
"""
